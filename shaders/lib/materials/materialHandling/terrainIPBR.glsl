...
if (mat < 11024) {
    ...
    if (mat < 12320) {
        if (mat < 12304) {
            ...
            if (mat < 12312) {
                if (mat < 12308) {
                    // block.12304 = blue_nether_bricks
                ...
                if (mat < 12316) {
                    // block.12312 = alphacene_mushroom
                    if (color.r > 0.9) {
                        emission = color.r > 0.95 ? 1.0 : 0.7 * pow2(color.r);
                        color.rgb *= color.rgb;
                    }
                } else /*if (mat < 12320)*/ {
                    // block.12316 = kinetic_core
        ...
        if (mat < 12324) {
            ...
            // block.12324 = spectralibur_pedestal
